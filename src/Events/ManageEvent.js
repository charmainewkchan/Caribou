...
class ManageEvent extends Component {
  ...
  handleCreateEvent(event) {
    ...
    else if(this.state.eventName.length>60) {
      alert('Please limit event title to 60 characters');
    }
    ...
    else if (this.state.eventCap >= 5000 || this.state.eventCap < 1 ) {
      alert('Please event a valid number (1-5000) for capacity.');
    }
    else if(!this.state.eventLoc){
      alert('Please enter a location.')
    }
    else if(this.state.eventLoc.length>100) {
      alert('Please limit location to 100 characters');
    }
    else {
      ...
      <div className="events-wrapper Events-event anim-fadeinright pb-2">
        <div className="container-fluid">
             ...
             <div className="input-group row Events-addEvent">
                <input className = "form-control" type = "text" minlenggth="1" maxlength="60" id = "title" placeholder = "Event Name" name = "eventName" value = {this.state.eventName} onChange = {this.handleChange}/>
             </div>

             <div className = "input-group row Events-addEvent">
              <textarea className="form-control " type="text" id="description" minlength="1" maxlength="500" placeholder = "Description" name = "eventDes" value= {this.state.eventDes} onChange={this.handleChange}/>
             </div>
             ...
             <div className="input-group row Events-addEvent">
              ...
              <input className = "form-control" type="number" id="eventCap" min="1" max="5000" name="eventCap" value={this.state.eventCap} onChange={this.handleChange} placeholder = ""/>
             </div>
             ...
             <div className="input-group row Events-addEvent">
              ...
              <input className = "form-control" type = "text" minlength="1" maxlength="60" id = "location" name = "eventLoc" value = {this.state.eventLoc} onChange = {this.handleChange} placeholder = ""/>
             </div>
